...
import { Home, FolderKanban, Plus, Sparkles, Menu } from 'lucide-react';
...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-[#DDE1E7] font-sans">
      <div className="max-w-[430px] mx-auto px-4 h-16 flex items-center justify-between relative">
        ...
        >
          <Menu className={`w-5 h-5 transition-transform group-hover:scale-105 ${
            activeTab === 'more' ? 'text-[#1677FF] stroke-[2.4]' : 'text-[#68707C] stroke-[1.8]'
          }`} />
          <span className={`text-[10px] tracking-tight mt-1 leading-none ${
