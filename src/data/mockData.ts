...
export const MOCK_TASKS: Task[] = [
  // ── SNELL ISLE RESIDENCE (proj-1) ──
  // 1. Engineering & Approvals
  {
    id: 't-eng-1',
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Geotechnical Soil Bearing Report',
    description: 'Borehole log test and soil load bearing capacity sign-off by structural engineer.',
    assignee: { id: 'usr_pm', name: 'Sarah Johnson', avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80', role: 'Project Manager' },
    startDate: '2024-10-05',
    dueDate: '2024-10-15',
    priority: 'Critical',
    status: 'Completed',
    milestone: '1. Engineering & Approvals',
    stageId: 'grp-eng',
    costCode: '01-4000 Soil Testing',
    subtasks: [{ id: 'st-e1', title: 'Collect core drill soil samples', completed: true }],
    attachmentsCount: 2,
    notesCount: 1
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Structural Engineering & Framing Calcs',
    description: 'Certified engineer review of shear wall load paths and uplift tie-down schedule.',
    assignee: { id: 'usr_pm', name: 'Sarah Johnson', avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80', role: 'Project Manager' },
    ...
    milestone: '1. Engineering & Approvals',
    stageId: 'grp-eng',
    costCode: '01-4100 Structural Calcs',
    subtasks: [{ id: 'st-e2', title: 'Verify moment frame connections', completed: true }],
    attachmentsCount: 3,
    notesCount: 2
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Engineered Truss Stamped Drawings',
    description: 'Manufacturer stamped truss layout and wind load engineering packets.',
    assignee: { id: 'usr_field', name: 'John Smith', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80', role: 'Lead Superintendent' },
    startDate: '2024-11-01',
    dueDate: '2024-11-12',
    priority: 'High',
    status: 'Completed',
    milestone: '1. Engineering & Approvals',
    stageId: 'grp-eng',
    costCode: '06-1000 Truss Engineering',
    subtasks: [],
    attachmentsCount: 1,
    notesCount: 0
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Hurricane Wind Load Compliance',
    description: 'High velocity hurricane zone (HVHZ) review and Florida building code compliance report.',
    assignee: { id: 'usr_pm', name: 'Sarah Johnson', avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80', role: 'Project Manager' },
  ...
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Civil Grading & Drainage Plan',
    description: 'Stormwater retention run-off calculations and site topography slope approval.',
    assignee: { id: 'usr_field', name: 'John Smith', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80', role: 'Lead Superintendent' },
    ...
    milestone: '1. Engineering & Approvals',
    stageId: 'grp-eng',
    costCode: '02-2000 Grading & Drainage',
    subtasks: [],
    attachmentsCount: 2,
    notesCount: 0
  },

  // 2. Pre-Construction & Permits
  {
    id: 't-pre-1',
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Boundary & Topographical Land Survey',
    description: 'St. Petersburg property boundary stakeout and setback verification.',
    assignee: { id: 'usr_field', name: 'John Smith', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80', role: 'Lead Superintendent' },
    startDate: '2024-12-01',
    dueDate: '2024-12-10',
    priority: 'High',
    status: 'Completed',
    milestone: '2. Pre-Construction & Permits',
    stageId: 'grp-precon',
    costCode: '01-3000 Land Survey',
    subtasks: [],
    attachmentsCount: 1,
    notesCount: 0
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'HOA Architectural Review Approval',
    description: 'Snell Isle homeowners association architectural committee signoff.',
    assignee: { id: 'usr_pm', name: 'Sarah Johnson', avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80', role: 'Project Manager' },
  ...
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'City Building Department Permit',
    description: 'Master building permit issued by St. Petersburg municipal building department.',
    assignee: { id: 'usr_pm', name: 'Sarah Johnson', avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80', role: 'Project Manager' },
  ...
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'DEP Environmental Stormwater Permit',
    description: 'Florida Department of Environmental Protection coastal zone clearance.',
    assignee: { id: 'usr_field', name: 'John Smith', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80', role: 'Lead Superintendent' },
    ...
    milestone: '2. Pre-Construction & Permits',
    stageId: 'grp-precon',
    costCode: '01-3300 DEP Clearance',
    subtasks: [],
    attachmentsCount: 2,
    notesCount: 0
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Temporary Power Pole & Water Hookup',
    description: 'Jobsite temporary electrical service pole and municipal meter installation.',
    assignee: { id: 'usr_field', name: 'John Smith', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80', role: 'Lead Superintendent' },
    ...
    milestone: '2. Pre-Construction & Permits',
    stageId: 'grp-precon',
    costCode: '01-5000 Temp Utilities',
    subtasks: [],
    attachmentsCount: 1,
    notesCount: 0
  },

  // 3. Site Work & Foundation
  {
    id: 't-fnd-1',
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Site Excavation & Pad Compaction',
    description: 'Clearing, stripping topsoil, fill dirt delivery, and 98% modified proctor pad compaction test.',
    assignee: { id: 'sub-earth', name: 'Apex Earthworks', avatar: 'https://images.unsplash.com/photo-1541888946425-d0fbb18615f8?w=150&auto=format&fit=crop&q=80', role: 'Excavation Subcontractor' },
    startDate: '2025-02-01',
    dueDate: '2025-02-14',
    priority: 'High',
    status: 'Completed',
    milestone: '3. Site Work & Foundation',
    stageId: 'grp-foundation',
    costCode: '02-3000 Excavation',
    subtasks: [],
    attachmentsCount: 1,
    notesCount: 1
  },
  {
    ...
    description: 'Sewer main, slab stub-outs, and hydrostatic water pressure testing.',
    assignee: { id: 'sub-mep', name: 'Titan MEP', avatar: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=150&auto=format&fit=crop&q=80', role: 'Plumbing Subcontractor' },
    ...
    milestone: '3. Site Work & Foundation',
    stageId: 'grp-foundation',
    costCode: '15-1000 Under-Slab Plumbing',
    subtasks: [],
    attachmentsCount: 2,
    notesCount: 0
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Stem Wall & Vapor Barrier Installation',
    description: 'CMU stem wall courses, termite pretreatment, and 15-mil Stego Wrap vapor barrier.',
    assignee: { id: 'sub-concrete', name: 'Suncoast Concrete', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80', role: 'Concrete Subcontractor' },
  ...
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Post-Tension Foundation Slab Pour',
    description: '450 cubic yard 4000 PSI monolithic slab pour with post-tension tendon layout and cylinder breaks.',
    assignee: { id: 'sub-concrete', name: 'Suncoast Concrete', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80', role: 'Concrete Subcontractor' },
    ...
    milestone: '3. Site Work & Foundation',
    stageId: 'grp-foundation',
    costCode: '03-3000 Slab Pour',
    subtasks: [],
    attachmentsCount: 5,
    notesCount: 3
  },

  // 4. Structural Framing & Concrete Slabs
  {
    id: 't-frm-1',
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'First & Second Floor Wood Framing',
    description: '2x6 exterior wall framing, laminated veneer lumber (LVL) headers, and floor joist erection.',
    assignee: { id: 'sub-frame', name: 'Apex Framing', avatar: 'https://images.unsplash.com/photo-1541888946425-d0fbb18615f8?w=150&auto=format&fit=crop&q=80', role: 'Framing Subcontractor' },
    startDate: '2025-03-16',
    dueDate: '2025-04-10',
    priority: 'High',
    status: 'Completed',
    milestone: '4. Structural Framing & Concrete Slabs',
    stageId: 'grp-framing',
    costCode: '06-1100 Wall Framing',
    subtasks: [],
    attachmentsCount: 3,
    notesCount: 1
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Roof Truss Erection & Shear Decking',
    description: 'Crane truss set, hurricane strap tie-downs, and 5/8" CDX roof plywood shear decking.',
    assignee: { id: 'sub-frame', name: 'Apex Framing', avatar: 'https://images.unsplash.com/photo-1541888946425-d0fbb18615f8?w=150&auto=format&fit=crop&q=80', role: 'Framing Subcontractor' },
  ...
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'City Framing & Shear Inspection',
    ...
    milestone: '4. Structural Framing & Concrete Slabs',
    stageId: 'grp-framing',
    costCode: '06-1300 Framing Inspection',
    subtasks: [
  ...
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Level 2 Elevated Deck Concrete Pour',
    ...
    milestone: '4. Structural Framing & Concrete Slabs',
    stageId: 'grp-framing',
    costCode: '03-3100 Elevated Slab',
    subtasks: [
  ...
  },
  {
    ...
    assignee: { id: 'usr_field', name: 'John Smith', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80', role: 'Superintendent' },
    ...
    subtasks: [
      { id: 'st-41', title: 'Inspect harness tie-off points Level 2', completed: false },
      { id: 'st-42', title: 'Verify GFCI breakers on temporary power spiders', completed: false }
    ],
    attachmentsCount: 1,
    notesCount: 1,
    location: 'Jobsite Perimeter'
  },

  // 5. MEP Utility Rough-In
  {
    id: 'tsk-2',
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'HVAC Overhead Ductwork & Line Sets',
    description: 'Coordinate mechanical ductwork and copper line set runs across second floor attic plenum.',
    assignee: { id: 'sub-mep', name: 'Titan MEP', avatar: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=150&auto=format&fit=crop&q=80', role: 'Mechanical Subcontractor' },
    startDate: '2025-05-16',
    dueDate: 'Today 1:30 PM',
    priority: 'High',
    status: 'In Progress',
    milestone: '5. MEP Utility Rough-In (Mech, Elec, Plumb)',
    stageId: 'grp-mep',
    costCode: '15-4000 Mechanical & HVAC',
    subtasks: [
      { id: 'st-21', title: 'Hang supply duct branches', completed: true },
      { id: 'st-22', title: 'Pull line set to condenser pads', completed: false }
    ],
    attachmentsCount: 1,
    notesCount: 2,
  ...
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Primary Romex Wiring & Electrical Boxes',
    description: 'Pull 12/2 and 14/2 Romex circuits to all designated switch boxes, recessed cans, and subpanel.',
    assignee: { id: 'sub-elec', name: 'Spark Electric', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80', role: 'Electrical Subcontractor' },
    ...
    milestone: '5. MEP Utility Rough-In (Mech, Elec, Plumb)',
    stageId: 'grp-mep',
    costCode: '16-1000 Electrical Rough-in',
    subtasks: [],
    attachmentsCount: 1,
    notesCount: 0
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Plumbing Drain Waste Vent Pressure Test',
    description: 'Hydrostatic 10-foot water column pressure test on all second floor sanitary stack vents.',
    assignee: { id: 'sub-mep', name: 'Titan MEP', avatar: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=150&auto=format&fit=crop&q=80', role: 'Plumbing Subcontractor' },
    ...
    milestone: '5. MEP Utility Rough-In (Mech, Elec, Plumb)',
    stageId: 'grp-mep',
    costCode: '15-2000 Sanitary DWV',
    subtasks: [],
    attachmentsCount: 0,
    notesCount: 0
  },

  // 6. Building Envelope & Exterior Glass
  {
    id: 't-env-1',
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Weather Barrier Housewrap & Flashing',
    description: 'Install Tyvek CommercialWrap and flexible butyl flashing tape around all window rough openings.',
    assignee: { id: 'sub-frame', name: 'Apex Framing', avatar: 'https://images.unsplash.com/photo-1541888946425-d0fbb18615f8?w=150&auto=format&fit=crop&q=80', role: 'Framing Subcontractor' },
    startDate: '2025-05-24',
    dueDate: 'Mon, Sep 14',
    priority: 'High',
    status: 'Not Started',
    milestone: '6. Building Envelope & Exterior Glass',
    stageId: 'grp-envelope',
    costCode: '07-2000 Moisture Barrier',
    subtasks: [],
    attachmentsCount: 0,
    notesCount: 0
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Impact Glass Windows & Sliders',
    description: 'Delivery and anchor installation of ESWindows insulated hurricane impact sliders.',
    assignee: { id: 'sub-glaz', name: 'ClearView Glazing', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80', role: 'Glazing Subcontractor' },
    ...
    milestone: '6. Building Envelope & Exterior Glass',
    stageId: 'grp-envelope',
    costCode: '08-5000 Impact Windows',
    subtasks: [],
    attachmentsCount: 2,
    notesCount: 1
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Exterior Stucco Scratch & Brown Coat',
    description: 'Apply metal lath, weeping screeds, and two coats of Portland cement stucco plaster.',
    assignee: { id: 'sub-stucco', name: 'Stucco Masters', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80', role: 'Stucco Subcontractor' },
    ...
    milestone: '6. Building Envelope & Exterior Glass',
    stageId: 'grp-envelope',
    costCode: '09-2000 Exterior Stucco',
    subtasks: [],
    attachmentsCount: 0,
    notesCount: 0
  },
  {
    ...
    projectId: 'proj-1',
    projectName: 'Snell Isle Residence',
    title: 'Roof Underlayment & Metal Standing Seam',
    description: 'Self-adhering high temp underlayment peel-and-stick membrane and 24-gauge Galvalume panels.',
    assignee: { id: 'sub-roof', name: 'Suncoast Roofing', avatar: 'https://images.unsplash.com/photo-1541888946425-d0fbb18615f8?w=150&auto=format&fit=crop&q=80', role: 'Roofing Subcontractor' },
    ...
    milestone: '6. Building Envelope & Exterior Glass',
    stageId: 'grp-envelope',
    costCode: '07-6000 Metal Roofing',
    subtasks: [],
    attachmentsCount: 1,
    notesCount: 0
  },

  // ── DOWNTOWN COMMERCIAL TOWER (proj-2) ──
  {
    id: 'tsk-3',
    projectId: 'proj-2',
    projectName: 'Downtown Commercial Tower',
    ...
    priority: 'High',
    status: 'In Progress',
    milestone: '4. MEP Heavy Systems Distribution',
    stageId: 'grp-p2-mep',
    costCode: '15-4000 Mechanical & HVAC',
    subtasks: [
  ...
  },
  {
    ...
    priority: 'Medium',
    status: 'Not Started',
    milestone: '2. Core Structural Steel & Decks',
    stageId: 'grp-p2-steel',
  ...
  },
  {
    ...
    priority: 'Critical',
    status: 'Blocked',
    milestone: '3. Curtain Wall & Building Envelope',
    stageId: 'grp-p2-facade',
...
export const MOCK_BUDGET_CATEGORIES: TradeCategory[] = [
  {
    ...
    icon: 'Boxes',
    estimatedCost: 370000,
    committedCost: 350000,
    actualCost: 320000,
    costCodes: [
      {
        code: '01-1000',
        ...
        variance: 30000,
        items: [
          { id: 'ci-1', code: '01-1001', name: 'Excavator & dozer rental', type: 'Equipment', unit: 'DAYS', quantity: 24, unitPrice: 4583, estimatedCost: 130000, committedCost: 125000, actualCost: 110000, paidCost: 100000, remaining: 20000, variance: 20000 },
          { id: 'ci-2', code: '01-1002', name: 'Earthwork labor crew', type: 'Labor', unit: 'HRS', quantity: 1200, unitPrice: 65, estimatedCost: 80000, committedCost: 75000, actualCost: 70000, paidCost: 65000, remaining: 10000, variance: 10000 }
        ]
      },
      {
        code: '01-2000',
        ...
        variance: 20000,
        items: [
          { id: 'ci-3', code: '01-2001', name: 'Culvert & drainage materials', type: 'Materials', unit: 'LF', quantity: 1600, unitPrice: 50, estimatedCost: 90000, committedCost: 85000, actualCost: 80000, paidCost: 75000, remaining: 10000, variance: 10000 },
          { id: 'ci-4', code: '01-2002', name: 'Underground trenching', type: 'Subcontractor', unit: 'LS', quantity: 1, unitPrice: 70000, estimatedCost: 70000, committedCost: 65000, actualCost: 60000, paidCost: 55000, remaining: 10000, variance: 10000 }
        ]
      }
    ]
  },
  {
    ...
    name: 'Concrete',
    icon: 'Building2',
    estimatedCost: 1420100,
    committedCost: 1365000,
    actualCost: 1120000,
    costCodes: [
      {
        code: '02-1000',
        name: 'Formwork',
        estimatedCost: 410500,
        committedCost: 405000,
        actualCost: 360000,
        variance: 50500,
        items: [
          { id: 'ci-5', code: '02-1001', name: 'Column & wall formwork', type: 'Equipment', unit: 'SF', quantity: 45000, unitPrice: 4.5, estimatedCost: 202500, committedCost: 200000, actualCost: 185000, paidCost: 160000, remaining: 17500, variance: 17500 },
          { id: 'ci-6', code: '02-1002', name: 'Formwork carpentry', type: 'Labor', unit: 'HRS', quantity: 3200, unitPrice: 65, estimatedCost: 208000, committedCost: 205000, actualCost: 175000, paidCost: 155000, remaining: 33000, variance: 33000 }
        ]
      },
      {
        code: '02-2000',
        ...
        variance: 60000,
        items: [
          { id: 'ci-7', code: '02-2001', name: 'Grade 60 rebar', type: 'Materials', unit: 'TON', quantity: 240, unitPrice: 1100, estimatedCost: 264000, committedCost: 260000, actualCost: 240000, paidCost: 220000, remaining: 24000, variance: 24000 },
          { id: 'ci-8', code: '02-2002', name: 'Rebar tying labor', type: 'Labor', unit: 'HRS', quantity: 1150, unitPrice: 70, estimatedCost: 116000, committedCost: 115000, actualCost: 80000, paidCost: 70000, remaining: 36000, variance: 36000 }
        ]
      },
      {
        code: '02-3000',
        name: 'Ready mix',
        estimatedCost: 629600,
        committedCost: 585000,
        actualCost: 440000,
        variance: 189600,
        items: [
          { id: 'ci-9', code: '02-3001', name: '5000 PSI ready mix', type: 'Materials', unit: 'CY', quantity: 3600, unitPrice: 150, estimatedCost: 540000, committedCost: 500000, actualCost: 380000, paidCost: 340000, remaining: 160000, variance: 160000 },
          { id: 'ci-10', code: '02-3002', name: 'Boom pump truck', type: 'Equipment', unit: 'DAYS', quantity: 32, unitPrice: 2800, estimatedCost: 89600, committedCost: 85000, actualCost: 60000, paidCost: 50000, remaining: 29600, variance: 29600 }
        ]
      }
    ]
  },
    ...
    costCodes: [
      {
        ...
        variance: 70000,
        items: [
          { id: 'ci-21', code: '03-1001', name: 'Wide flange steel', type: 'Materials', unit: 'TON', quantity: 180, unitPrice: 2500, estimatedCost: 500000, committedCost: 480000, actualCost: 450000, paidCost: 400000, remaining: 50000, variance: 50000 },
          { id: 'ci-22', code: '03-1002', name: 'Steel erection labor', type: 'Labor', unit: 'HRS', quantity: 2400, unitPrice: 75, estimatedCost: 200000, committedCost: 190000, actualCost: 180000, paidCost: 160000, remaining: 20000, variance: 20000 }
        ]
      }
    ]
  },
    ...
    costCodes: [
      {
        ...
        committedCost: 305000,
        actualCost: 290000,
        variance: 30000,
        items: [
          { id: 'ci-11', code: '04-1001', name: 'Copper & PEX piping', type: 'Materials', unit: 'LF', quantity: 4500, unitPrice: 38, estimatedCost: 190000, committedCost: 180000, actualCost: 170000, paidCost: 150000, remaining: 20000, variance: 20000 },
          { id: 'ci-12', code: '04-1002', name: 'Plumber labor', type: 'Labor', unit: 'HRS', quantity: 1500, unitPrice: 80, estimatedCost: 130000, committedCost: 125000, actualCost: 120000, paidCost: 110000, remaining: 10000, variance: 10000 }
        ]
      },
      {
        code: '04-2000',
        ...
        committedCost: 370000,
        actualCost: 350000,
        variance: 40000,
        items: [
          { id: 'ci-13', code: '04-2001', name: 'Switchgear & transformers', type: 'Equipment', unit: 'EA', quantity: 2, unitPrice: 100000, estimatedCost: 200000, committedCost: 190000, actualCost: 180000, paidCost: 160000, remaining: 20000, variance: 20000 },
          { id: 'ci-14', code: '04-2002', name: 'Conduit & wire install', type: 'Subcontractor', unit: 'LS', quantity: 1, unitPrice: 190000, estimatedCost: 190000, committedCost: 180000, actualCost: 170000, paidCost: 150000, remaining: 20000, variance: 20000 }
        ]
      }
    ]
  },
    ...
    costCodes: [
      {
        ...
        variance: 20000,
        items: [
          { id: 'ci-15', code: '05-1001', name: 'Drywall & metal studs', type: 'Materials', unit: 'EA', quantity: 3200, unitPrice: 44, estimatedCost: 150000, committedCost: 145000, actualCost: 140000, paidCost: 120000, remaining: 10000, variance: 10000 },
          { id: 'ci-16', code: '05-1002', name: 'Tape & finish labor', type: 'Labor', unit: 'HRS', quantity: 1400, unitPrice: 65, estimatedCost: 100000, committedCost: 95000, actualCost: 90000, paidCost: 80000, remaining: 10000, variance: 10000 }
        ]
      },
      {
        code: '05-2000',
        ...
        variance: 20000,
        items: [
          { id: 'ci-17', code: '05-2001', name: 'Primer & paint', type: 'Materials', unit: 'GAL', quantity: 850, unitPrice: 130, estimatedCost: 120000, committedCost: 115000, actualCost: 110000, paidCost: 95000, remaining: 10000, variance: 10000 },
          { id: 'ci-18', code: '05-2002', name: 'Exterior stucco', type: 'Subcontractor', unit: 'LS', quantity: 1, unitPrice: 90000, estimatedCost: 90000, committedCost: 85000, actualCost: 80000, paidCost: 70000, remaining: 10000, variance: 10000 }
        ]
      }
    ]
  },
    ...
    costCodes: [
      {
        ...
        variance: 30000,
        items: [
          { id: 'ci-19', code: '06-1001', name: 'Fencing & scaffolding', type: 'Equipment', unit: 'MO', quantity: 6, unitPrice: 9167, estimatedCost: 70000, committedCost: 60000, actualCost: 55000, paidCost: 50000, remaining: 15000, variance: 15000 },
          { id: 'ci-20', code: '06-1002', name: 'Waste hauling', type: 'Subcontractor', unit: 'LS', quantity: 1, unitPrice: 80000, estimatedCost: 80000, committedCost: 70000, actualCost: 65000, paidCost: 60000, remaining: 15000, variance: 15000 }
        ]
      }
    ]
  }
